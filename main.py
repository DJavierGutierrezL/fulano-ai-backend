# main.py - VERSIÓN FINAL CON POKÉMON Y MARVEL
...
# ... (Las herramientas anteriores no cambian, se omiten por brevedad)
...
# --- NUEVAS HERRAMIENTAS: POKÉMON Y MARVEL ---
...
def search_marvel_character(character_name: str):
    ...
    try:
        ...
        return {
            "name": character["name"],
            "description": character["description"] or "No hay una descripción disponible.",
...
# ... (Middleware y Modelos de Datos sin cambios)
...
def chat(request: ChatRequest):
    ...
    try:
        ...
        # AÑADIMOS LAS NUEVAS HERRAMIENTAS A LA LISTA DE GEMINI
        ...
        if function_call:
            ...
            # AÑADIMOS LA LÓGICA PARA EJECUTAR LAS NUEVAS HERRAMIENTAS
